...
|--------------------------------|-------|-----------------------------------------|
|building_lod0                   |polygon|建物フットプリント2Dポリゴンとその属性                     |
|building_centroid_lod0          |point  |建物フットプリントポリゴンのセントロイドとその属性                |
|building_detail                 |table  |建築物に関する基礎的な情報                            |
|building_large_customer_facility|table  |大規模小売店舗や大規模集客施設に関する基礎的な情報                |
|building_data_quality           |table  |地物インスタンスごとのデータの作成情報                      |
|building_risk_flooding          |table  |洪水浸水想定区域内に存在する建築物に付与された浸水想定区域がもつ属性       |
|building_risk_tsunami           |table  |津波洪水浸水想定の区域内に存在する建築物付与した津波浸水想定の区域の属性     |
|building_risk_high_tide         |table  |高潮浸水想定区域に存在する建築物に付与した高潮浸水想定区域の属性を        |
|building_risk_internal_overflow |table  |内水浸水想定区域に存在する建築物に付与した内水浸水想定区域の属性         |
|building_risk_land_slide        |table  |土砂災害警戒区域及び土砂災害特別警戒区域に存在する建築物に付与した区域に関する属性|
|building_generic_attributes     |table  |建物モデルの汎用属性                               |
|building_extended_attributes    |table  |建物モデルの拡張属性                               |
|
